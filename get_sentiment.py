...
def get_response(prompt):
    ...
    messages = [
        ...
        {"role": "user",
            "content": f"Bạn hãy dự đoán cảm xúc của khách hàng theo 2 lớp: positive và negative. Nếu cảm xúc là tích cực thì trả về Label: positive, nếu cảm xúc là tiêu cực thì trả về Label: negative. Chỉ trả về nội label (positive hoặc negative), không thêm gì khác"},
